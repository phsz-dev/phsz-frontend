<template>
  <div class="absolute bottom-0 w-full bg-white p-4 dark:bg-dark-block-600">
    <div class="container mx-auto flex justify-between">
      <button
        class="px-4 py-2 text-gray-600 enabled:hover:text-gray-800 disabled:text-gray-400 dark:text-gray-200 dark:enabled:hover:text-gray-50"
      ...
      <button
        ...
        @click="
          questionIndex + 1 === totalQuestions ? emit('submit') : nextQuestion()
        "
      >
